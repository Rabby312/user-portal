...
jQuery(document).ready(function () {
    ...
    jQuery('.card-body').on('click', '.add-new-number ', function () {
        ...
        portal.ajax.call({
            url: portal.baseURL + "contactDetails/create",
            dataType: "html",
                ...
                confirm: {
                    ...
                    action: function () {
                        if(contactId !== undefined){
                            portal.ajax.call({
                                url: portal.baseURL + "contactDetails/delete/" + contactId,
                                success: function (content) {
                                    if(content.success === true){
                                        portal.messageBox.showMessage(true, content.info);
                                        _this.closest(".form-group").remove();
                                    }else{
                                        portal.messageBox.showMessage(false, content.info)
                                    }
                                }
                            });
                        }else{
